...
- [x] Layout Lab as a reusable tool (Jun 13) — Settings > Layout Lab: a tab (left rail, grouped by domain) for every one of the 20 real pages, each auto-seeded with its real boxes; drag/resize, lock, hide, adjustable snap grid, density, auto-arrange, and move-a-box-to-another-page; Copy this page exports the arrangement. Once confirmed working, retire the standalone /jobs/layout-lab
