...
- [ ] Layout Lab as a reusable tool — move it into Settings with a tab per page (read-only previews), per-widget lock/hide/snap-grid, and move-a-box-to-another-page; use it to redesign multiple pages
