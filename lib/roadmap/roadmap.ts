...
- [~] Dark-mode token + gaps — DONE: the hardcoded dark card color (dark:bg-[#10243a], ~440 literals) is now the single brand-panel token (identical hex, verified). Remaining: add dark: variants to the ~100 status banners (emerald/amber success/warning boxes) that only have light styles. (Surfaced by the Jun 30 design audit.)
