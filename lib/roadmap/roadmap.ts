...
- [~] Accessibility pass (WCAG 2.1 A/AA) — DONE: one consistent gold :focus-visible keyboard ring for every interactive element (there were zero focus styles before). Remaining: aria-labels on icon-only buttons, an icon/shape alongside color-only status pills, and lifting low-contrast brand-grey body text to meet 4.5:1. (Surfaced by the Jun 30 design audit.)
