    ...
    <div className="space-y-4 px-5 py-5 lg:px-8">
      <section className="rounded bg-white p-5 shadow-panel ring-1 ring-brand-lea/10 dark:bg-brand-panel dark:ring-white/10">
        ...
        <p className="mt-1 max-w-3xl text-sm text-brand-grey dark:text-slate-400">
          ...
          changes the live pages until you ask to bake an arrangement in. Use <span className="font-semibold text-brand-lea dark:text-slate-100">Copy this page</span> to grab a layout.
        </p>
      </section>
      <SettingsLayoutLab />
    </div>
