...
export default function ErrorPage({ error, reset }: ErrorPageProps) {
  return (
    <div className="flex min-h-[calc(100vh-42px)] items-center justify-center px-5 py-8">
      <section className="w-full max-w-xl rounded bg-white p-5 shadow-panel ring-1 ring-brand-red/20 dark:bg-brand-panel dark:ring-red-500/30">
        <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-brand-red dark:text-red-400">Workspace error</p>
