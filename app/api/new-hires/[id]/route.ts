...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  try {
    ...
    for (const field of ["name", "legalName", "position", "department", "location", "managedAircraft", "phone", "ssEmail", "personalEmail", "supervisorName", "supervisorEmail", "supervisorHireId", "birthCountry", "citizenshipCountry", "travelStatus", "notes", "candidateId"]) {
