      ...
      <section className="rounded bg-white p-4 shadow-panel ring-1 ring-brand-lea/10">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
          <div>
            ...
            <h3 className="text-base font-semibold text-brand-lea">Role identity</h3>
          ...
          {groupedGates.map((group) => (
            <div key={group.category}>
              ...
              <div className="grid gap-2 xl:grid-cols-2 2xl:grid-cols-3">
                {group.gates.map((gate) => (
                  <div key={gate.id} className="rounded border border-brand-lea/10 bg-brand-cloudDancer/45 p-3">
                    <label className="flex items-start gap-2">
                      ...
                      />
                      <span>
                        <span className="block text-sm font-semibold text-brand-lea">{gate.label}</span>
                        <span className="block text-[11px] font-semibold uppercase tracking-[0.12em] text-brand-grey">
                          {gate.valueType}
                        </span>
                      </span>
                    </label>
