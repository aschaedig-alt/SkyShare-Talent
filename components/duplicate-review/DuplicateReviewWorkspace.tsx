    ...
    <div className="space-y-4 px-5 py-5 lg:px-8">
      ...
      <section className="rounded bg-white shadow-panel ring-1 ring-brand-lea/10 dark:bg-brand-panel dark:ring-white/10">
        <div className="border-b border-brand-lea/10 px-4 py-3 dark:border-white/10">
          ...
          <h2 className="text-base font-semibold text-brand-lea dark:text-slate-100">Open and recent review items</h2>
        </div>
        <div className="p-4">
          {data.items.length > 0 ? (
            <div className="space-y-2">
              {data.items.map((item) => (
                <div key={item.id} className="rounded border border-brand-lea/10 bg-brand-cloudDancer/45 p-3 dark:border-white/10 dark:bg-white/5">
            ...
            <div className="rounded border border-brand-lea/10 bg-brand-cloudDancer/45 p-8 text-center dark:border-white/10 dark:bg-white/5">
              <div className="text-lg font-semibold text-brand-lea dark:text-slate-100">No duplicate review items yet</div>
