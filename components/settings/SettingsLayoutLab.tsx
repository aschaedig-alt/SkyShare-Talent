  ...
  return (
    <div className="flex flex-col gap-4 lg:flex-row">
      ...
      <aside className="shrink-0 lg:w-60">
        <div className="rounded bg-white p-3 shadow-panel ring-1 ring-brand-lea/10 dark:bg-[#10243a] dark:ring-white/10">
      ...
      <div className="min-w-0 flex-1">
        <section className="mb-3 flex flex-wrap items-start justify-between gap-3 rounded bg-white p-4 shadow-panel ring-1 ring-brand-lea/10 dark:bg-[#10243a] dark:ring-white/10">
          <div>
        ...
        >
          ...
          >
            {visibleBoxes.map((b) => {
              ...
              return (
                <div key={b.id} className={`flex flex-col overflow-hidden rounded border bg-white shadow-panel dark:bg-[#10243a] ${isLocked ? "border-brand-gold ring-2 ring-brand-gold/40" : "border-brand-lea/15 dark:border-white/10"}`}>
      ...
      {moveMenu && (
        <>
          ...
          <div
            className="fixed z-50 max-h-[60vh] w-60 overflow-auto rounded border border-brand-lea/20 bg-white p-1.5 shadow-xl dark:border-white/10 dark:bg-[#10243a]"
