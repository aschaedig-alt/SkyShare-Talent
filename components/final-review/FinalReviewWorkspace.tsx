            ...
            <div className="grid gap-3 md:grid-cols-[minmax(220px,1fr)_minmax(260px,1.3fr)_auto] md:items-end">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded border border-brand-lea/15 bg-white px-3 py-2.5 text-sm font-semibold text-brand-lea outline-none focus:border-brand-eden focus:ring-4 focus:ring-brand-sweet/35"
                >
              ...
              <div className="rounded bg-brand-cloudDancer px-3 py-2 text-xs font-bold uppercase tracking-[0.1em] text-brand-lea">
        ...
        <aside className="space-y-5 xl:sticky xl:top-5 xl:self-start">
          <section className="rounded bg-white p-4 shadow-panel ring-1 ring-brand-lea/10">
            <div className="mb-3">
              ...
              <h2 className="mt-1 text-lg font-semibold text-brand-lea">Checklist before copying</h2>
            </div>
          ...
          <section className="rounded bg-white shadow-panel ring-1 ring-brand-lea/10">
            <div className="border-b border-brand-lea/10 p-4">
              ...
              <h2 className="mt-1 text-lg font-semibold text-brand-lea">Copy for job boards</h2>
            ...
            <div className="space-y-4 p-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded border border-brand-lea/12 bg-white px-3 py-2 text-xs font-bold text-brand-lea hover:bg-brand-cloudDancer"
                >
              ...
              <textarea
                readOnly
                value={exportValue}
                className="min-h-[460px] w-full resize-y rounded border border-brand-lea/12 bg-brand-cloudDancer/35 px-3 py-3 text-xs leading-5 text-brand-black outline-none focus:border-brand-eden focus:ring-4 focus:ring-brand-sweet/30"
                spellCheck={false}
              />
            </div>
          </section>
