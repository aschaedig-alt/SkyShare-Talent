    ...
    <div className="rounded-xl bg-white p-4 shadow-panel ring-1 ring-brand-lea/10">
      ...
      <div className="mt-3">
        ...
        <div className="mt-1.5 flex flex-wrap gap-1.5">
          ...
          {pros.map((p) => (
            <span key={p} className="inline-flex items-center gap-1 rounded-full border border-emerald-200 bg-emerald-50 px-2.5 py-1 text-[11px] font-semibold text-emerald-800">
              {p}
      ...
      <div className="mt-4">
        ...
        <div className="mt-1.5 flex flex-wrap gap-1.5">
          ...
          {cons.map((c) => (
            <span key={c} className="inline-flex items-center gap-1 rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-[11px] font-semibold text-amber-800">
              {c}
