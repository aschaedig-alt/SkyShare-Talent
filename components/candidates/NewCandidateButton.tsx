  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg bg-brand-gold px-4 py-2.5 text-sm font-semibold text-brand-lea transition hover:bg-brand-sweet dark:text-slate-100"
      >
