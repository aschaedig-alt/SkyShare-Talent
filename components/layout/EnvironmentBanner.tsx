...
export function EnvironmentBanner() {
  ...
  return (
    <div className="border-b border-brand-lea/10 bg-white/90 px-5 py-2 text-xs text-brand-grey lg:px-8 dark:border-white/10 dark:bg-[#10243a]/90 dark:text-slate-400">
